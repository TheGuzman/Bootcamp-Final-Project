...
export default function CreateFishbowlPage() {
  ...
  function handleSubmit(e) {
    ...
    fetch(`${url}/user/becomeafish/myfishbowls/createfishbowl`, options).then((r) => {
      r.json();
    ...
    <React.Fragment>
      <Stack direction="row" sx={{ alignItems: "center", justifyContent: "space-between" }}>
        <Typography sx={{ margin: "0em 1em" }} variant="h5">
          {t("createFishbowlPage.createAFishbowl")}
        </Typography>
      ...
      <Box sx={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center" }}>
        <Typography sx={{ margin: "1em" }} variant="h6">
          {t("createFishbowlPage.addFishbowl")}
        </Typography>
        <form onSubmit={handleSubmit}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: "2em", alignItems: "center" }}>
            <TextField
              sx={{ "@media (min-width:760px)": { width: "30em", gap: "1em" } }}
              required
        ...
        <Box sx={{ display: "flex", justifyContent: "center", margin: "1em" }}>
          <Stack direction="column" sx={{ width: "fit-content", borderRadius: "10px", alignItems: "center" }}>
            <SuccessStack sx={{ borderRadius: "10px" }}>
              <Typography sx={{ margin: "0em 1em", fontWeight: "bold", textAlign: "center" }} variant="button">
                {t("createFishbowlPage.fishbowlCreated")}
              </Typography>
            </SuccessStack>
            <Stack direction="row" sx={{ margin: "1em", cursor: "pointer" }}>
              ...
              <Typography
                ...
                component={Link}
                to="/becomeafish/myfishbowls"
              >
                {t("createFishbowlPage.backToFishbowlsMsg")}
              </Typography>
            </Stack>
          </Stack>
        </Box>
