  ...
  return (
    <Stack>
      <Stack
        direction="column"
        sx={{
          "@media (min-width:768px)": { flexDirection: "row", gap: 4 },
          margin: "2em",
          alignItems: "center",
      ...
      >
        ...
        <QuestionTitle sx={{ textAlign: "center" }} variant="h1">
          {t("homePage.greeting.preposition")}
        </QuestionTitle>
      ...
      <Stack
        sx={{
          ...
          "@media (min-width:1024px)": { flexDirection: "row", justifyContent: "space-around" },
        }}
      >
        <Stack
          direction="column"
        ...
        >
          ...
          <Typography variant="h5" sx={{ textAlign: "center" }}>
            {t("homePage.questions.answerWhyCare")}
          </Typography>
        </Stack>
      </Stack>
      <Stack alignItems={"center"} sx={{ margin: "1em 1em", "@media (min-width:768px)": { margin: "3em 1em" } }}>
        <Button
          ...
          color="secondary"
          sx={{ width: "40%", color: "primary.contrastText", "@media (min-width:768px)": { width: "15%" } }}
        >
          {showMore !== true ? `${t("buttons.knowMore")}` : `${t("buttons.knowLess")}`}
        </Button>
      </Stack>

      <Stack
        style={{ backgroundImage: `url(${Fishes})`, backgroundSize: "contain", height: "100%", minHeight: "40em" }}
      ...
      >
        {showMore !== false ? (
          <React.Fragment>
            <Stack
              direction="column"
              sx={{ margin: "4em 1em", alignItems: "center", backgroundColor: "background.special" }}
            >
              <SecondaryTittles variant="h3">{t("homePage.questions.howWorks")}</SecondaryTittles>
              <Typography variant="h5" sx={{ textAlign: "center" }}>
                {t("homePage.questions.answerHowWorks")}
              </Typography>
            </Stack>
            <Stack
              direction="column"
            ...
            >
              <Typography variant="body" textAlign={"center"} sx={{ fontStyle: "italic" }}>
                “If you have an apple and I have an apple and we exchange these apples, then you and I will still each
                have one apple. But if you have an idea and I have an idea and we exchange these ideas, then each of us
                will have two ideas."
              </Typography>
