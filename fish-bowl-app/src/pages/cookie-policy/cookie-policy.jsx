...
export default function CookiePolicy() {
    return (
        <div  style={{margin:'1em'}}>
            <h1>Cookie Policy for Fishbowlapp</h1>

            <p>This is the Cookie Policy for Fishbowlapp, accessible from Fishbowlapp</p>
            ...
            <ul>
                ...
                <li>By visiting this link: fishbowlappfordiscussions@gmail.com</li>
            </ul>
