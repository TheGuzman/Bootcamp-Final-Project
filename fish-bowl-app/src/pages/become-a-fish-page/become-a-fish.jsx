        ...
        <Box>
            <Stack direction='row' sx={{ alignItems: 'center', justifyContent: 'space-between', margin: '1em 0em' }}>
                <Stack direction='row' sx={{ '@media (min-width:320px)': { flexDirection: 'column' }, '@media (min-width:768px)': { flexDirection: 'row' } }}>
                    <Typography sx={{ margin: '0em 0.5em 0em 1em' }} variant='h5'>{t("becomeaFishPage.welcome")}</Typography>
            ...
            <Box>
                <Stack direction='column' sx={{ alignItems: 'center', justifyContent: 'space-between', }}>
                    <Typography sx={{ margin: '0em 1em' }} variant='h6'>{t("becomeaFishPage.info")}</Typography>
                    <Filter onFilter={onFilter}></Filter>

                    <Box border={2} sx={{ borderColor: 'primary.main', backgroundImage: `url(${Fishes})`, backgroundSize: 'contain', padding: '0.5em', borderRadius: '10px', alignItems: 'center', margin: '1em', width: '90%', minHeight: 370 }}>
